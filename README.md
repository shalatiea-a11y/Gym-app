# Finance AI Report Generator

A web app that generates AI-powered financial reports. Enter company financial data into the form, click Generate, and get a structured summary report.
